...
public class FieldOfView : MonoBehaviour
{
    ...
    [SerializeField] float meshResolution=4f;
    [SerializeField] int edgeResolveIterations=2;
    [SerializeField] float edgeDstThreshold=0;
    [SerializeField] float maskCutawayDst = 0f;
...
/*
    ...
    private void LateUpdate() {
        ...
        for (int i = 0; i <= rayCount; i++) {
            Vector3 vertex;
            RaycastHit hit;
            //Physics.Raycast(transform.position, GetVectorFromAngle(angle), viewDistance, layerMask); //  .Raycast(origin, GetVectorFromAngle(angle), viewDistance, layerMask);
